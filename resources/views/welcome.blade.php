<x-public-layout>
    <div class="flex flex-col mb-12">
        <span class="font-mono text-lg font-normal pl-16 pb-4">Hi, I'm</span>
        <div class="flex justify-center items-center mb-4">
            <span class="font-mono text-5xl text-center md:text-9xl font-normal pb-4">{ ans }</span>
        </div>
        <span class="flex justify-center font-mono text-lg font-normal mt-4">from Malaysia and I'm a PHP web
            developer.</span>
                ...
                <div
                    ...
                    <div class="flex flex-col">
                        <div class="flex flex-row justify-center items-center">
                            ...
                            <span
                                class="font-inter text-xs font-semibold">siti_anasuha_resume_{{ Date('Y') }}.pdf</span>
                        </div>
        ...
        <div class="flex justify-end items-center mt-3.5">
            <span class="font-mono text-xs font-medium">psst! my resume is ats friendly 😜</span>
        </div>
    </div>
</x-public-layout>
